...
A complete collection of Claude Code skills for US Healthcare Revenue Cycle Management.

## Interactive Skills (MCP-Powered)

These skills leverage real-time healthcare data APIs:

| Skill | Command | Description | MCP Tools |
|-------|---------|-------------|-----------|
...
| `mimilabs` | CMS/CDC/FDA Datasets | rcm-analytics |
...
- **Additional files**: Templates, examples (where applicable)
